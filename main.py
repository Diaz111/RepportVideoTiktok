...
patrecviash = "\033[1;32m[ENVIADO] ID DO VÍDEO: "+id+" | DIVICE-ID: ["+str(random.randint(110000000000, 19999999999999))+"]"
...
while True:
    ...
    print("\033[1;32m[LuizzTzy Exexuting] Relatório bem-sucedido: "+id+" | DIVICE-ID: ["+str(random.randint(1000000000, 9999999999))+"]")
